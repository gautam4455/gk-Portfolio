        ...
        <Fragment>
            <nav className="navbar navbar-expand-lg navbarDark" ref={navbarRef}>
                <div className="container-fluid">
                    <Link id="logo" className="navbar-brand" to="/" onClick={hideNavbarContent}>
                        {/* <strong>&lt; GK &gt;</strong> */}
                        <img src={Logo} alt="Logo" />
                    </Link>

                    <button type="button" id="hamburger-btn" className="navbar-toggler" data-bs-toggle="collapse" data-bs-target="#navbarContent">
                    ...
                    <div className="collapse navbar-collapse" id="navbarContent" ref={navbarContent}>
